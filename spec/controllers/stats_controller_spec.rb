  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stat as @stat" do
        ...
        post :create, {:stat => { "name" => "invalid value" }}, valid_session
        assigns(:stat).should be_a_new(Stat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stat" do
        ...
        Stat.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => stat.to_param, :stat => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stat as @stat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stat.any_instance.stub(:save).and_return(false)
        put :update, {:id => stat.to_param, :stat => { "name" => "invalid value" }}, valid_session
        assigns(:stat).should eq(stat)
      end
